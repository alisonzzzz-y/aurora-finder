...
const messages = {
  en: {
    ...
    stormOutlookLimit: 'This is a geomagnetic outlook, not an exact eruption time or a personal chance of seeing aurora. Kp times are shown in UTC.',
  ...
  zh: {
    ...
    stormOutlookLimit: '这是地磁活动预报，不是精确的爆发时间，也不是个人看到极光的概率。Kp 时段以 UTC 显示。',
